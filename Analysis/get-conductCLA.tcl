...
# Open output files
set out [open permeationCLA-$d.dat w] ;# Detailed events
set out2 [open overallCLA-$d.dat w]   ;# Overall statistics
...
# This usually ensures the center is calculated based on the transmembrane helix/pore region
